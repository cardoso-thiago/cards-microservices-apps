...
import br.com.mastertech.payment.model.Error;
import br.com.mastertech.payment.model.builder.ErrorBuilder;
...
public class RestExceptionHandler {
    @ExceptionHandler(value = {PaymentSystemException.class})
    protected ResponseEntity<Object> handleSistemaCartoesException(PaymentSystemException e) {
    ...
    protected ResponseEntity<Object> handleFeignExceptionUnprocessableEntity(FeignException.UnprocessableEntity e) {
